  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input id = "npass" placeholder="새 비밀번호" type="password" class="form-control mb-2">
		<input id = "cpass" placeholder="새 비밀번호 확인" type="password" class="form-control mb-2">
      </div>
